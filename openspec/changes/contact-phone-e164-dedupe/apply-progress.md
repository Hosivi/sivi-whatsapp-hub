...
- [x] Task 1 — Created `apps/backend/test/contacts/phone-e164.test.ts` (28 spec scenarios + vitest.config.ts)
  ...
  - Commit: `test(contacts): add failing phone-e164 + result unit tests (red)` (a010787)
- [x] Task 2 — Created `apps/backend/src/shared/result.ts`
  ...
  - Commit: `feat(shared): add Result<T,E> discriminated union and helpers` (711d66c)
- [x] Task 3 — Created `apps/backend/src/contacts/phone-e164.ts`
  ...
  - Commit: `feat(contacts): add phone-e164 normalizer, batch, and dedupe detection` (b8d8f1a)
...
1. `a010787` — `test(contacts): add failing phone-e164 + result unit tests (red)`
2. `711d66c` — `feat(shared): add Result<T,E> discriminated union and helpers`
3. `b8d8f1a` — `feat(contacts): add phone-e164 normalizer, batch, and dedupe detection`
